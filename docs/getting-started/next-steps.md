...
| Ingest data from a real source | [Connectors tutorial](../tutorials/connectors.md). |
| Record my first event | [Events tutorial](../tutorials/events.md). |
| Understand plugin discovery | [Registry tutorial](../tutorials/registry.md). |
| Turn analytics into decisions | [Decision tutorial](../tutorials/decision.md). |
| Search for the best plan | [Optimization tutorial](../tutorials/optimization.md). |
| Orchestrate autonomous work | [AI Agents tutorial](../tutorials/agents.md). |
| Present it to a human | [Visualization tutorial](../tutorials/visualization.md). |
